  ...
  return (
    <Row className="blog-item" gutter={{ md: 24, lg: 32 }}>
      ...
      <Col className="blog-meta" sm={24} md={12} lg={14}>
        ...
        <Paragraph>{firstParagraph.slice(0, 200)}...</Paragraph>
